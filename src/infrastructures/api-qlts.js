...
const httpQlts = axios.create({
  baseURL: config.domainApiQLTS
})

httpQlts.interceptors.request.use(
  (requestConfig) => {
...
httpQlts.interceptors.response.use(function (response) {
  // Do something with response data
  retry = 0
  return response
}, handleError)

export default httpQlts
