...
const httpHrmUni = axios.create({
  baseURL: config.baseApiHrmUniUrl
})

httpHrmUni.interceptors.request.use(
  (requestConfig) => {
...
httpHrmUni.interceptors.response.use(function (response) {
  // Do something with response data
  retry = 0
  return response
}, handleError)

export default httpHrmUni
