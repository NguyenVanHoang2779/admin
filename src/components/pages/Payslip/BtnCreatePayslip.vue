  ...
  methods: {
    ...
    checkBeforeCreatePayslip () {
      ...
      let dataSearch = {
        ...
        formula: this.dataFilter.formula
      }

      payslipService.checkBeforeCreatePayslip(dataSearch).then((response) => {
    ...
    createPayslipByFilter () {
      ...
      payslipService.createPayslipByFilter(dataSearch).then((response) => {
        if (response.data.success) {
