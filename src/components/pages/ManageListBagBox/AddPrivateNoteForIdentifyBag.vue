<template>
  <b-modal header-class="justify-content-center" header-bg-variant="green" static no-close-on-esc hide-header-close
           :title="'Ghi chú bao ' + bagErpAlias + ' (ID: #' + bagOrder + ' )'" v-model="showModal" hide-footer scrollable
...
export default {
  name: 'AddPrivateNoteForIdentifyBag',
  props: {
  ...
  methods: {
    hideModal () {
      ...
      this.$emit('changedPrivateNoteIdentifyBag', {
