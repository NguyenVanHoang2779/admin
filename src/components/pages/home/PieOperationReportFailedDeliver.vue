<template>
  <div>
    <b-card class="default-pie-chart" no-body>
      <h6 class="pt-3 pl-4">Nguyên nhân không giao được</h6>
...
export default {
  name: 'pie-operation-report-failed-deliver',
    ...
    options: {
      ...
      legend: {
        ...
        data: [
          ...
          'Không liên lạc được với khách 3 lần',
          'Khách hẹn giao lại quá 3 lần',
          'Shop báo hủy đơn hàng',
          'Đối tác hủy đơn qua API',
          'Lý do khác'
        ]
      },
      series: [{
  ...
  methods: {
    getData: function () {
      ...
      dashboardV4.getOperationReportFailedDeliverPieChartData(params)
        .then((res) => {
          if (res.data.success) {
