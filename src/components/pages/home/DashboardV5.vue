<template>
  <div class="dashboard-v2">
    ...
    <div class="ui-block ecom-dashboard-home">
      ...
      <hr>
      <graph-operation-by-time-report :fromDate="fromDate" :toDate="toDate" :isChange="isChange"></graph-operation-by-time-report>
    </div>
    <div class="ui-block ecom-dashboard-home">
      <h4 class="ui-block-heading">
        Sản lượng liên vùng
      ...
      <hr>
      <graph-station-quantity :fromDate="fromDate" :toDate="toDate" :isChange="isChange"></graph-station-quantity>
    </div>
  </div>
</template>
<style scoped>
...
import GraphOperationByTimeReport from 'components/charts/GraphOperationByTimeReport'
import GraphStationQuantity from 'components/charts/GraphStationQuantity'
...
export default {
  ...
  components: {
    ...
    GraphOperationByTimeReport,
    GraphStationQuantity,
  ...
  created () {
    dashboardService.getMaxTimeOfDataV5().then((response) => {
