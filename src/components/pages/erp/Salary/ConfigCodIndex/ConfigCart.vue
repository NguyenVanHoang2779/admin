<template>
  <b-card-body>
    <b-row>
      <h3 class="ml-3">Config Chỉ Số Hội Nhập</h3>
    </b-row>
    <br>
    <b-row>
      <b-col>
      ...
      <b-col>
        <multiselect
          ...
          :options="indexIntegrationOptions"
          :multiple="true"
          placeholder="Chọn chỉ số hội nhập"
          label="name"
          track-by="name"
      ...
      <CreateConfigCart :model-pop-up-name="`Tạo config chỉ số hội nhập`" :type-index="typeIndex" :options="optionIntegration" :title-create="`Chọn chỉ số hội nhập`" @getConfig="getConfig"/>
      <UpdateConfigCart :model-pop-up-name="`Update config chỉ số hội nhập`" :type-index="typeIndex" :options="optionIntegration" :title-create="`Chọn chỉ số hội nhập`" @getConfig="getConfig" :data-update="dataUpdate"/>
    </b-row>
...
import CreateConfigCart from './component/CreateConfigCart'
import UpdateConfigCart from './component/UpdateConfigCart'
...
export default {
  ...
  data: () => ({
    typeIndex: 'integration',
    optionIntegration: [
      {id: 1, name: 'Chỉ số hội nhập 1'},
      {id: 2, name: 'Chỉ số hội nhập 2'},
      {id: 3, name: 'Chỉ số hội nhập 3'}
    ],
    dataUpdate: null,
    configCart: false,
    provinceIds: null,
    ...
    fieldsDataConfig: [
      ...
      {key: 'index_number', label: 'Chỉ số hội nhập', sortable: true},
