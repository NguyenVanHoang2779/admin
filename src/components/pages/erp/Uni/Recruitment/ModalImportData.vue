<template>
  <div>
    <b-modal modal-class="modal-custom" static centered id="modal-import-data-candidate" @hide="resetForm()" hide-footer
             hide-header>
      ...
      <div class="modal-content-import-data">
        ...
        <div class="mt-4">
          ...
          <div class="text-center mt-2">
            ...
            <b-button class="btn btn-outline-ghtk button-import-data" @click="triggerInputFileDataDisabled"
                      id='candidate-btn-import-data' name='candidate-btn-import-data'
                      v-if="!isUploading">
...
export default {
  ...
  methods: {
    ...
    exportSampleFile () {
      window.open('https://cache.giaohangtietkiem.vn/d/ab77f4810c1fcb96fa7ce3c8e2d06b71.xlsx')
    }
  }
}
</script>
