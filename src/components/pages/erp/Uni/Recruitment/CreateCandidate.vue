<template>
  <div>
    <div class="top-title row mb-3">
      <h2 class="col-md-3">{{ 'Tạo ứng viên' }}</h2>
      <div class="top-title__right-button col-md-4 text-right"  style="margin-left: auto; margin-right: 0">
        <b-btn @click="openLink('/adm/staff-work/recruitment')" style="margin-left: auto; margin-right: 0" class="btn btn-default" title="Về màn quản lý ứng viên"><i class="ion ion-ios-return-left"></i> Quay lại</b-btn>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
                    ...
                    <div class="card-body">
                      ...
                      <b-form-row>
                        ...
                        <b-form-group id="input-group-phone" class="col-md-3">
                          ...
                          <b-form-input v-model="user_info.email" type="email" placeholder="Email"></b-form-input>
                        </b-form-group>
                      </b-form-row>
                      <b-form-row>
                          ...
                          <div>
                            ...
                            <b-form-row>
                              <div class="input-group col-md-12 mb-1">
                                ...
                                <input type="text" class="form-control text-center" v-model="work_experience.income_last_six_month.from" @input="validMoney(work_experience.income_last_six_month, 'from')">
                                <div class="input-group-prepend">
                                  <span class="input-group-text">Đến</span>
                                </div>
                                <input type="text" class="form-control text-center" v-model="work_experience.income_last_six_month.to" @input="validMoney(work_experience.income_last_six_month, 'to')">
                                <div class="input-group-append">
                        ...
                        <div class="col-md-6">
                          <b-form-group label="Mức lương mong muốn đạt được?">
                            <div class="input-group mb-1">
                              ...
                              <input type="text" class="form-control text-center" v-model="work_experience.desired_salary.from" @input="validMoney(work_experience.desired_salary, 'from')">
                              <div class="input-group-prepend">
                                <span class="input-group-text">Đến</span>
                              </div>
                              <input type="text" class="form-control text-center" v-model="work_experience.desired_salary.to" @input="validMoney(work_experience.desired_salary, 'to')">
                              <div class="input-group-append">
                                <span class="input-group-text">VNĐ</span>
                              </div>
                            </div>
    ...
    <div class="card-footer border-0 text-center py-3">
      <b-btn type="button" variant="btn btn-success" @click="createCandidate" :disabled="isDisabled">
        Tạo
      </b-btn>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    validMoney (object, field) {
      object[field] = object[field].replace(/\D/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, ',')
    },
    ...
    createCandidate () {
      ...
      recruitmentService.createCandidate(formData).then(res => {
        if (res.data.success) {
          commonHelper.showMessage('Tạo ứng viên thành công', 'success')
          const id = res.data.data.id
          this.$router.push({ name: 'update-candidate', params: { id } })
        } else {
