      ...
      <div class="row mb-2">
        <div class="col-md">
          ...
          <div>
            <b-row class="my-1">
              <b-col class="label-penalty-search" sm="3">
                <label class="font-italic">Mã bao:</label>
              </b-col>
              <b-col sm="9">
                <input-bag-order @model="searchData.inputBagOrder = $event"></input-bag-order>
              </b-col>
            </b-row>
          </div>
          ...
          <div>
            <b-row class="my-1">
              <b-col class="label-penalty-search" sm="3">
                <label class="font-italic">Trạng thái nhân viên</label>
              </b-col>
              <b-col sm="9">
                <select-status-user @model="searchData.selectStatusUser = $event"></select-status-user>
              </b-col>
            </b-row>
          </div>
        </div>
        <div class="col-md">
          <div>
            <b-row class="my-1">
              <b-col class="label-penalty-search" sm="3">
                <label class="font-italic">Người bị phạt:</label>
              </b-col>
              <b-col sm="9">
          ...
          <div>
            <b-row class="my-1">
              ...
              <b-col sm="9">
                <selected-station @model="searchData.selectStationPenalty = $event" :station-id="createdStation" @dataReady="dataReady"></selected-station>
              </b-col>
            </b-row>
          </div>
          ...
          <div>
            <b-row class="my-1">
              <b-col class="label-penalty-search" sm="3">
                <label class="font-italic">ID bản ghi phạt:</label>
              </b-col>
              <b-col sm="9">
                <input-penalty-id @model="searchData.inputPenaltyId = $event"></input-penalty-id>
              </b-col>
            </b-row>
          </div>
        </div>
        <div class="col-md">
          ...
          <div>
            <b-row class="my-1">
              <b-col class="label-penalty-search" sm="3">
                <label class="font-italic" for="deadline-time">Deadline bắt đầu:</label>
              </b-col>
              <b-col sm="9">
                <b-form-input
                  type="datetime-local"
                  v-model="searchData.deadline_time_from"
                ></b-form-input>
              </b-col>
            </b-row>
          </div>
          <div>
            <b-row class="my-1">
              <b-col class="label-penalty-search" sm="3">
                <label class="font-italic" for="deadline-time">Deadline kết thúc:</label>
              </b-col>
              <b-col sm="9">
                <b-form-input
                  type="datetime-local"
                  v-model="searchData.deadline_time_to"
                ></b-form-input>
              </b-col>
            </b-row>
          </div>
...
import InputPackageOrder from './InputPackageOrder'
import InputBagOrder from './InputBagOrder'
import InputPenaltyId from './InputPenaltyId'
import SelectUserPenalty from './SelectUserPenalty'
import SelectStatusPenalty from './SelectStatusPenalty'
import SelectGroupPenalty from './SelectGroupPenalty'
import SelectPositionPenalty from './SelectPositionPenalty'
import SelectedStation from './SelectedStation.vue'
import SelectProvincePenalty from './SelectProvincePenalty'
import SelectTypePenalty from './SelectTypePenalty'
import SelectCardPenalty from './SelectCardPenalty'
import SelectStatusUser from './SelectStatusUser.vue'
...
export default {
  ...
  data: () => ({
    ...
    searchData: {
      ...
      selectProvincePenalty: [],
      inputPenaltyId: [],
      deadline_time_from: null,
      deadline_time_to: null
    },
    cardMoney: cardMoney,
  ...
  computed: {
    ...
    linkApiExport () {
      ...
      let dataSend = {
        ...
        bag_orders: this.searchData.inputBagOrder,
        penalty_ids: this.searchData.inputPenaltyId,
        types: this.searchData.selectTypePenalty,
        status: this.searchData.selectStatusPenalty,
        status_user: this.searchData.selectStatusUser,
        ...
        deadline_time_from: this.searchData.deadline_time_from ? moment(new Date(this.searchData.from)).format('YYYY-MM-DD H:i:s') : null,
        deadline_time_to: this.searchData.deadline_time_to ? moment(new Date(this.searchData.to)).format('YYYY-MM-DD H:i:s') : null,
  ...
  methods: {
    ...
    getDataPenalties () {
      let dataSend = {
        ...
        station_ids: this.searchData.selectStationPenalty,
        card: this.searchData.selectCardPenalty,
        deadline_time_from: this.searchData.deadline_time_from ? moment(new Date(this.searchData.deadline_time_from)).format('YYYY-MM-DD HH:mm:ss') : null,
        deadline_time_to: this.searchData.deadline_time_to ? moment(new Date(this.searchData.deadline_time_to)).format('YYYY-MM-DD HH:mm:ss') : null,
        page: this.page.currentPage,
        limit: this.page.perPage
      }

      if (dataSend.penalty_ids.length === 0 && (dataSend.from == null || dataSend.to == null)) return commonHelper.showMessage('Không được để trống Ngày bắt đầu và Ngày kết thúc')
