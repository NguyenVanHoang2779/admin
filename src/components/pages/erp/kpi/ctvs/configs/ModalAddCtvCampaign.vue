<template>
    <b-modal ref="modalconfig" hide-footer id="modal-add-ctv-campaign">
      <div slot="modal-title">Thêm cụm config</div>
      <div class="row">
        <div class="col-md">
      ...
      <div class=" row float-right mt-5">
        <b-btn @click="$bvModal.hide('modal-add-ctv-campaign')" variant="secondary">Hủy</b-btn>&nbsp;
...
export default {
  name: 'modal-add-ctv-config-campaign',
  props: {
    campaign: {
      type: Object,
      required: false
  ...
  methods: {
    ...
    saveData () {
      ...
      let dataSend = {
        ...
        from: moment(this.options.date_from).format('YYYY-MM-DD'),
        to: moment(this.options.date_to).format('YYYY-MM-DD'),
