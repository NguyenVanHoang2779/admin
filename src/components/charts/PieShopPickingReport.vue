<template>
  <div>
    <h4 class="font-weight-bold py-3 mb-6 text-center">
      <span class="text-muted font-weight-light">Top Shop</span>
    </h4>
    <ecom-table-shop-picking-report :childRes="childRes"></ecom-table-shop-picking-report>
    <div class="echarts">
...
import EcomTableShopPickingReport from 'components/tables/EcomTableShopPickingReport'
import EcomLoadingWanderingCubes from 'components/elements/loading/EcomLoadingWanderingCubes'

export default {
  name: 'pie-shop-picking-report',

  components: {
    'vue-echart': ECharts,
    EcomTableShopPickingReport,
  ...
  methods: {
    getPieOptions: function () {
      ...
      params['reportType'] = 2
      dashboardV2.getShopPicking(params)
        .then((response) => {
