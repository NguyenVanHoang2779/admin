<template>
  <div>
    ...
    <ecom-table-province-delivering-report :childRes="childRes"></ecom-table-province-delivering-report>
    <div class="echarts">
...
import EcomTableProvinceDeliveringReport from 'components/tables/EcomTableProvinceDeliveringReport'
import EcomLoadingWanderingCubes from 'components/elements/loading/EcomLoadingWanderingCubes'

export default {
  name: 'pie-province-delivering-report',

  components: {
    'vue-echart': ECharts,
    EcomTableProvinceDeliveringReport,
  ...
  methods: {
    getPieOptions: function () {
      ...
      dashboardV2.getProvinceDelivering(params)
        .then((response) => {
